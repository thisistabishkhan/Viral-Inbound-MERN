        ...
        <section id="home" class="hero">
            ...
            <div class="container">
                <div class="hero-content">
                    <div class="hero-text">
                        <h1 class="hero-title" ref={titleRef} style={{ minHeight: '1.2em' }}>{titleText}</h1>
                        <p class="hero-subtitle">Viral Inbound is Mumbai's trusted partner for web design and SEO services. We combine expert web design with comprehensive SEO optimization to help businesses across Mumbai and India achieve measurable growth online.</p>
                        <p class="hero-supporting">Our team builds responsive websites, implements AI-powered SEO strategies, and creates digital marketing campaigns that actually work. We focus on results that matter: more visibility, better rankings, and real business growth.</p>
                        <div class="hero-ctas">
                            <a href="https://cal.com/viralinbound" class="btn btn-primary btn-large" target="_blank" rel="noopener noreferrer">Book a Strategy Call</a>
                            <a href="#contact" class="btn btn-secondary btn-large">Get a Free Website & SEO Audit</a>
                        </div>
                    </div>
                    <form class="hero-form" id="heroForm" novalidate onSubmit={handleSubmit}>
                        <div class="form-row">
                        ...
                        <button type="submit" class="btn btn-primary btn-large" style={{ width: '100%' }}>Request a Callback</button>
                        <div class="form-message" id="heroFormMessage"></div>
                    </form>
                </div>
            </div>
        </section>
